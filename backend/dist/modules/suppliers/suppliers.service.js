...
export class SupplierService {
    ...
    static async create(data) {
        ...
        await pool.execute('INSERT INTO suppliers (id, name, contact, email, phone, address) VALUES (?, ?, ?, ?, ?, ?)', [id, data.name, data.contact || null, data.email || null, data.phone || null, data.address || null]);
        return { id, ...data };
    }
